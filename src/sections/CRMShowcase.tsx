        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-400 mb-10 leading-relaxed">
              Я проектирую системы вокруг того, как реально работает ваш бизнес: лиды, клиенты, менеджеры, задачи, статусы и аналитика. Никаких лишних кнопок, только то, что нужно для роста.
            </p>
